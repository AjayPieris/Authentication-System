    ...
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      {!isEmailSent && (
        <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
          ...
          <button type='submit' className='cursor-pointer w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 transition-colors'>
            Submit
          </button>
        </form>
      )}
      ...
      {isEmailSent && !isOtpSubmited && (
        <form onSubmit={onSubmitOtp} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
          ...
          <button type='submit' className='cursor-pointer w-full bg-blue-600 text-white py-2.5 rounded hover:bg-blue-700 transition-colors'>
            Submit
          </button>
          ...
          <div className='text-center text-sm text-gray-300 mt-4 '>
            ...
            >
              {resendLoading ? 'Resending...' : (resendCooldown > 0 ? `Resend available in ${resendCooldown}s` : 'Resend')}
            </button>
          </div>
        </form>
      )}
